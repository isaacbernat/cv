...
%         \small \textit{Staff Software Engineer with 12+ years of experience specializing in backend systems, architecture, and product strategy. Proven track record of leading high-impact initiatives that drive significant business results, including delivering a \textbf{+3\% global Gross Margin lift} and architecting systems instrumental in securing a \textbf{Series C funding round}.}
%     \end{minipage}
% \end{center}
% \vspace{-0.5em}
...
\begin{itemize}[leftmargin=*, topsep=4pt, partopsep=0pt, itemsep=8pt, parsep=0pt] % Roles within Wrapp
